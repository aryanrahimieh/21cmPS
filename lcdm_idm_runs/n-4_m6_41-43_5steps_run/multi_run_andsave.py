...
for i in range(len(sigma0)):
    ...
    wr_path = '/scratch1/rahimieh/21cmfirstclass_outputs/idm_multi_m_6_sigma_%.2f_index_-4_BOXLEN_200_HIIDIM_50_msamp_T/' %sigma0[i]
    label='IDM_nm4_m6_sigma_%.2f' %sigma0[i]
...
fig1.savefig('./output_pngs/5ple_run_manysamples_true/Tk_n-4_m6_s-42.png',dpi=100)
fig3.savefig('./output_pngs/5ple_run_manysamples_true/global_n-4_m6_s-42.png',dpi=100)
fig5.savefig('./output_pngs/5ple_run_manysamples_true/PS_n-4_m6_s-42.png',dpi=100)
