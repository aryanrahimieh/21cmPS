...
cosmo_params['m_chi'] = 0. # mass of the SDM particle. This is in fact log_10(m_chi/eV), thus we simulate here SDM with a mass of m_chi=1 MeV.
...
for i in range(len(sigma0)):
    ...
    label='IDM_nm4_m0_sigma_%.2f' %sigma0[i]
...
fig1.savefig('./output_pngs/5ple_run_manysamples_true/Tk_n-4_m0_s-42.png',dpi=100)
fig3.savefig('./output_pngs/5ple_run_manysamples_true/global_n-4_m0_s-42.png',dpi=100)
fig5.savefig('./output_pngs/5ple_run_manysamples_true/PS_n-4_m0_s-42.png',dpi=100)
