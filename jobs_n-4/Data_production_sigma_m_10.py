...
cosmo_params['m_chi'] = 10. # mass of the SDM particle. This is in fact log_10(m_chi/eV), thus we simulate here SDM with a mass of m_chi=1 MeV.
...
sigma_steps = np.linspace(46,50,5)
sigma_fid   = 0
