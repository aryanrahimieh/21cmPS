...
def run_lcone_lcdm(wr_path, user_params, astro_params, flag_options, cosmo_params, global_quantities, lightcone_quantities):
    start_time = time.time()
    lightcone = p21c.run_lightcone(redshift = 6., # minimu
                                        random_seed = 2, # numerical seed -- 
...
wr_path = subdir_org_data + r'lcdm_BOXLEN_%1.0f_HIIDIM_%1.0f/' %(user_params['BOX_LEN'], user_params['HII_DIM'])
print("\n", wr_path)
### 1-running lightcones
lightcones[wr_path] = run_lcone_lcdm(wr_path, 
...
global_temp_filename = subdir_small_data + r"Tb_lcdm_seed2.csv" 
...
ps_filename = subdir_small_data +  r"ps_lcdm_seed2.npz" 
...
input_filename = subdir_small_data +  r"input_lcdm_seed2.json" 
