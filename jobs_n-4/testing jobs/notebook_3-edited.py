...
fig0.savefig('Tk_lcdm.png',dpi=100)
...
fig1, ax1 = plotting.plot_global_history(lightcone_SDM,kind='Tk_box',ax=ax1,label='SDM')
fig1.savefig('Tk_n-4_m6_s-42.png',dpi=100)
...
fig3, ax3 = plotting.plot_global_history(lightcone_SDM,ax=ax3,label='n-4_m6_s-42')
fig3.savefig('global_n-4_m6_s-42.png',dpi=100)
...
fig4, ax4 = plotting.plot_global_history(lightcone_LCDM,ax=ax4,color='k',label='$\Lambda$CDM')
fig4, ax4 = plotting.plot_global_history(lightcone_SDM,ax=ax4,label='SDM (default redshift sampling)')
fig4, ax4 = plotting.plot_global_history(lightcone_SDM2,ax=ax4,label='SDM (more samples at cosmic dawn)')

ax4.set_xscale('linear')
ax4.set_xlim([6,35])
fig4.savefig('global_comp_n-4_m6_s-42.png',dpi=100)
...
fig5.savefig('PS_n-4_m6_s-42.png',dpi=100)